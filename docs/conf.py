...
g = {}
with open(
    os.path.join(os.path.dirname(__file__), "..", "invenio_imoox", "version.py"), "rt"
) as fp:
    exec(fp.read(), g)
...
html_theme_options = {
    ...
    "extra_nav_links": {
        "invenio-imoox@GitHub": "https://github.com/tu-graz-library/invenio-imoox",
        "invenio-imoox@PyPI": "https://pypi.python.org/pypi/invenio-imoox/",
    },
}
...
htmlhelp_basename = "invenio-imoox_namedoc"
...
man_pages = [(master_doc, "invenio-imoox", u"invenio-imoox Documentation", [author], 1)]
